...
using VerifyCS = TolggeUI.SourceGenerators.Tests.SourceGeneratorVerifier<TolggeUI.SourceGenerators.RenderObjectGenerator>;


namespace TolggeUI.SourceGenerators.Tests;
