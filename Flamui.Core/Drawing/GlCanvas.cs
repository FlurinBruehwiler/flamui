...
{
    public static void IssueDrawCall(Renderer renderer, ReadOnlySpan<RectInfo> rects, int width, int height)
    {
        ...
        renderer.Gl.Uniform2(renderer.MainProgram.U_ViewportSize, new Vector2(width, height));
