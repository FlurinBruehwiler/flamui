...
public class Div : RenderObject, IEnumerable<RenderObject>
{
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public Dir PDir { get; set; } = TolggeUI.Dir.Vertical;

    [EditorBrowsable(EditorBrowsableState.Never)]
    public MAlign PmAlign { get; set; } = TolggeUI.MAlign.FlexStart;

    [EditorBrowsable(EditorBrowsableState.Never)]
    public XAlign PxAlign { get; set; } = TolggeUI.XAlign.FlexStart;
