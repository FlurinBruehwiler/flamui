...
public class WindowManager
{
    ...
    public readonly Component.UiComponent RootUiComponent;
    ...
    public WindowManager(TolggeApp tolggeApp, IWindowImpl window, Type rootType, CancellationTokenSource cancellationTokenSource)
    {
        ...
        RootUiComponent = (Component.UiComponent)ActivatorUtilities.CreateInstance(TolggeApp.Services, rootType);
        RootUiComponent.Builder = Builder;
        ...
        Builder.ShouldRebuild(RootUiComponent);
    }
